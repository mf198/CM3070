...
from ccfd.models.classifiers_gpu import (
    train_random_forest_gpu, train_knn_gpu, train_logistic_regression_gpu,
    train_mbgd_gpu, train_xgboost_gpu
)
...
def test_models_with_oversampling(filepath: str, threshold_method: str, use_gpu: bool):
    """
    ...
    for oversampling_name, oversampling_function in oversampling_methods.items():
        ...
        for model_name, model_function in models.items():
            ...
            # Evaluate model
            metrics = evaluate_model(model, X_test, y_test, threshold_method=threshold_method)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--threshold", choices=["default", "pr_curve", "cost_based"], default="default",
    ...
    test_models_with_oversampling(dataset_path, threshold_method, use_gpu)
