...
import numpy as np
import pandas as pd
from cuml.ensemble import RandomForestClassifier as RandomForestClassifierGPU
...
#model = RandomForestClassifier(n_estimators=100, max_depth=10, random_state=42, bootstrap=True)
#model.fit(X_train_resampled, y_train_resampled)  
...
model = RandomForestClassifierGPU(n_estimators=1500, max_depth=10, random_state=42, bootstrap=True, n_bins=256, n_streams=1)
model.fit(X_train_resampled, y_train_resampled)  
