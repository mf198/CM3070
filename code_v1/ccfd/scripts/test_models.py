...
from ccfd.models.classifiers_gpu import (
    ...
    train_mbgd_gpu, train_xgboost_gpu, evaluate_model_gpu
)
...
from ccfd.models.classifiers_cpu import (
    ...
    train_sgd, train_xgboost, evaluate_model_cpu
)
...
def test_models_with_oversampling(filepath: str, use_gpu: bool):
    """
